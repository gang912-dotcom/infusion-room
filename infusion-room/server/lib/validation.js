...
// ─── 용량 ────────────────────────────────────────────────────────────
// 용량은 선택지('110')일 수도, 근무자가 직접 적는 값('24mL')일 수도 있어 자유 텍스트다.
// 길이만 막는다 — 형식을 강제하면 '1/2A'처럼 실제로 쓰는 표기를 못 적는다.
// 상한을 두는 이유는 수량과 같다: 잘못 들어간 긴 문자열이 기록지에 그대로 인쇄된다.
export const DOSE_MAX_LENGTH = 20
