...
// 비타D 항목코드. 몇 달에 한 번 맞는 약이라 묶음에 들어 있어도 오늘은 빼고 나가는 처방이
// 잦다 — '고른 처방' 칸에서 빨갛게 세우고, 묶음을 누를 때 한 번 알린다.
// 두 곳(App.jsx의 알림 · OrderSummary의 강조)이 같은 값을 봐야 해서 여기 둔다. 이 파일이
// 묶음↔처방 대조를 맡고 있고 둘 다 이미 이 모듈 쪽을 보고 있어 순환 import가 안 생긴다.
// ponytail: 특정 약 코드를 코드에 박았다. 이런 약이 더 생기면 order_items에 '확인 필요' 칸을 둔다.
export const VITD_CODE = 'vitd'
